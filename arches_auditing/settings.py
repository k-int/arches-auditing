"""
Django settings for arches_auditing app.
"""
...
DATATYPE_LOCATIONS.append('arches_auditing.datatypes')
FUNCTION_LOCATIONS.append('arches_auditing.functions')
ETL_MODULE_LOCATIONS.append('arches_auditing.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_auditing.search_components')
...
SECRET_KEY = 'django-insecure-+2tqwkrp(j1z2xis)b^byvct3&^-s_-zhc&sd!2t)#-v6h7&nz'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_auditing.urls"
ROOT_HOSTCONF = "arches_auditing.hosts"
...
ELASTICSEARCH_PREFIX = 'arches_auditing'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_auditing.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_auditing",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'arches_auditing.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_auditing'
...
LANGUAGES = [
    # ('de', _('German')),
    ('en', _('English')),
    # ('ar', _('Arabic')),      # Arabic (RTL)
    # ('he', _('Hebrew')),      # Hebrew (RTL)
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_auditing.search.es_mapping_modifier.EsMappingModifier"]

OAUTH2_PROVIDER = {"ACCESS_TOKEN_EXPIRE_SECONDS": 2000000}
